...
dataset_train = pd.read_csv('E:/PTKT/Predict_CP/vcb_2009_2018.csv')
...
if path.exists("mymodel.h5"):
    ...
    regressor.save("E:/PTKT/Predict_CP/mymodel.h5")

# Load du lieu tu 1/1/2019 - 2/10/2019
dataset_test = pd.read_csv('E:/PTKT/Predict_CP/vcb_2019.csv')
